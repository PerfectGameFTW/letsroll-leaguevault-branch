...
export function WarmProfessional() {
          ...
          <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
              <div>
                ...
                <p className="text-slate-500 mt-1">Here's what's happening across your leagues today.</p>
              </div>
              <Button className="bg-amber-600 hover:bg-amber-700 text-white shadow-sm shadow-amber-600/20 rounded-full px-6">
                + New League
              </Button>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
              <Card className="border-stone-200 shadow-sm hover:shadow-md transition-shadow duration-200 bg-white overflow-hidden group">
                <div className="h-1 w-full bg-slate-200 group-hover:bg-amber-400 transition-colors"></div>
            ...
            <Card className="border-stone-200 shadow-sm bg-white overflow-hidden">
              <CardHeader className="border-b border-stone-100 bg-stone-50/50 flex flex-row items-center justify-between py-5">
                <div>
                ...
                <Button variant="outline" className="border-stone-200 text-slate-600 hover:text-slate-800 hover:bg-stone-50 hidden sm:flex">
                  View All
                </Button>
              </CardHeader>
              <CardContent className="p-0">
                <Table>
                  <TableHeader className="bg-stone-50/80">
                    <TableRow className="border-stone-200 hover:bg-transparent">
                      <TableHead className="text-slate-500 font-medium py-4 pl-6">Bowler Name</TableHead>
                      <TableHead className="text-slate-500 font-medium py-4">League</TableHead>
                      <TableHead className="text-slate-500 font-medium py-4">Status</TableHead>
                      <TableHead className="text-slate-500 font-medium py-4">Last Paid</TableHead>
                      <TableHead className="text-slate-500 font-medium text-right py-4">Amount Due</TableHead>
                  ...
                  <TableBody>
                    {pastDueBowlers.map((bowler, idx) => (
                      <TableRow 
                        key={bowler.id} 
                        className={`border-stone-100 transition-colors ${idx % 2 === 0 ? 'bg-white' : 'bg-stone-50/30'} hover:bg-stone-50`}
                      >
                ...
                <div className="p-4 border-t border-stone-100 bg-stone-50/30 flex justify-center sm:hidden">
                  <Button variant="outline" className="w-full border-stone-200 text-slate-600">
                    View All
                  </Button>
                </div>
              </CardContent>
